...
const SystemOperationView: NextPage = () => (
  <MainWrapper title="System Operation">
    <Styles.Container>
          ...
          <Card variant="outlined">
            <CardContent style={{ paddingBottom: 8 }}>
              ...
              >
                ...
                modificação de dados, os apontamentos são inicialmente salvos
                aqui nesse timesheet, melhorando no geral a experiência de
                usuário.
              </Typography>
              <Typography
                variant="body2"
          ...
          <Card variant="outlined">
            <CardContent style={{ paddingBottom: 8 }}>
              ...
              >
                ...
                existem apontamentos que ainda não foram lançados para o
                timesheet oficial, o número encontrado junto ao mesmo, indica a
                quantidade de apontamentos a serem lançados.
              </Typography>
              <Typography
                variant="body2"
                color="text.secondary"
          ...
          <Card variant="outlined">
            <CardContent style={{ paddingBottom: 8 }}>
              ...
              <Typography
                ...
                paragraph
              >
                Os principais dados do sistema são importado do timesheet
                oficial, clientes, projetos, categorias e apontamentos são
                carregados após realizar o login com a sua conta do timesheet
                oficial.
              </Typography>
              <Typography
                variant="body2"
